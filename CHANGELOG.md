...
## [UNRELEASED]
### Added
- Ability to pickle `GeneInterval`, `FeatureInterval`, `FeatureIntervalCollection`, and `TranscriptInterval` objects with their parents

## [1.2.1] 2024-07-09
### Fixed
- Bug with BED parser parsed spliced CDS

## [1.2.0] 2024-07-09
### Added
- BED parser enables creating AnnotationCollection objects from BED files, with optional FASTA parsing.


## [1.1.0] 2023-10-06
### Added
- GTF export is now enabled for genes. GTF does not support features.
