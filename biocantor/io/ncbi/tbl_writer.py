...
from biocantor.gene import GeneInterval
...
from biocantor.io.ncbi.exc import TblExportException
from biocantor.location import Location
from biocantor.location.location_impl import CompoundInterval
